...
以下は今後の構想であり、現時点では未実装です。詳細な設計メモは [Simulation Roadmap](./docs/ja/guide/roadmap.md) にまとめています。

### 1. 時間圧縮レイヤーの導入

- 現実時間とシミュレーション時間を変換する仕組みを入れる
- 初期案として `現実の 1 時間 = 国家内の 1 日` を扱えるようにする
- 日課、政策更新、経済ターン、イベント要約が圧縮された国家時間で進むようにする

### 2. 三国志風の敵対国構造

- 単一国家シミュレーションから、`ONI-CADIA` を含む複数国家の均衡へ拡張する
- まずは 3 つの主要国家を置き、思想、統治スタイル、軍事姿勢、資源特性を分ける
- 内政だけでなく、外交、交易、宣伝、国境事件、衝突の段階的エスカレーションを扱えるようにする

### 3. もっと国家らしくするために必要な要素

- 政府機関、省庁、指揮系統、地方行政
- 法、政策変更、税、予算、兵站、資源循環
- 領土、国境、インフラ、公文書、見える形の国家史
- 世論、正統性、安全保障圧力、生産性など、上下する国家指標

### 4. 人口拡張

- 初期の 3 人体制を超えて国民数を増やす
- 指導層、公務層、労働層、創作者、商人、兵士、外部勢力などの社会層を表現する
- 募集、移住、昇進、離脱、補充のような人口変動を入れて、国家が時間とともに変化するようにする
