...
6. 文献を書く。
7. 名前、モデル、アイコンが維持されていることを確認する。
8. その後にactive memoryと広場文脈を初期化する。

## 維持する不変条件

明示的に変更しない限り、リセット時もこの対応表を維持します。
...
次に、前文明の文献へのリンクを貼ります。その文献は現在の記憶ではなく、必要なときに参照できる遺跡として扱います。
...
- 国民広場には、新しい使命、文献リンク、リセット後の新しい発話だけが見えている。
