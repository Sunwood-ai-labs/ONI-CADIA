...
- The tracked starter state includes the default triad, expanded civic seats, and optional NVIDIA-backed seats 7-9, so larger experiments can start from reviewed scaffolds instead of ad-hoc copies.
